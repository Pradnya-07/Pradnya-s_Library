...
const Hero = () => {
    return (
        ...
        <form  className="relative w-full max-w-sm md:max-w-xl lg:max-w-3xl text-base lg:text-lg">
            <input type="text"  className="w-full px-3 py-1.5 md:py-2 text-[#252422] rounded-lg placeholder:text-gray-600 bg-[#FFFCF2]"/>

            <button placeholder="Type anything to search here" 
             className="absolute right-0 top-0 bottom-0 bg-[#403D39] px-4 border border-white transitionfont-semibold rounded-r-lg">Search</button>
        </form>
            </div>
        </div>
    )
